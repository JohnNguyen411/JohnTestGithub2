...
class FTUEStartViewController: LogoViewController {
    ...
    let loginButton = VLButton(type: .blueSecondary, title: NSLocalizedString("viewIntroFooterSignin", tableName: "").uppercased(), kern: UILabel.uppercasedKern(), event: .signIn, screen: .landing)

    let signupButton = VLButton(type: .blueSecondary, title: NSLocalizedString("viewIntroFooterSignup").uppercased(), kern: UILabel.uppercasedKern(), event: .createAccount, screen: .landing)
