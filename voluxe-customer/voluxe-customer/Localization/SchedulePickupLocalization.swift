//
//  SchedulePickupLocalization.swift
//  voluxe-customer
//
...
extension String {
    ...
    static let CurrentLocation = NSLocalizedString("CurrentLocation")
    static let UpdatingLocation = NSLocalizedString("UpdatingLocation")
    ...
    static let PermissionLocationDenied = NSLocalizedString("PermissionLocationDenied")
    static let OpenSettings = NSLocalizedString("OpenSettings")
    static let LocationPermission = NSLocalizedString("LocationPermission")
